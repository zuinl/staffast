<?php
    ...
    if($_POST['setor'] == "") {
        $_SESSION['msg'] = "Você precisa selecionar um setor para filtrar";
        header('Location: avaliacaoSetor.php');
        die();
    }
    ...
    $condicao = "";
    $filtros = "";
    if (isset($_GET['dataI']) && isset($_GET['dataI'])) {
      $condicao .= "WHERE avs_data_criacao >= '".$_POST['dataI']."' AND avs_data_criacao <= '".
      ...
      $condicao .= "WHERE set_id = ".$_POST['setor'];
      $dataI = date_create($_POST['dataI']);
      $dataF = date_create($_POST['dataF']);
      $setor = $setor->retornarSetor($_SESSION['empresa']['database']);
      $filtros .= "Todo o período <br>Setor: ".$setor->getNome();
    }
...
<div class="container-fluid" style="text-align: center;">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="avaliacaoSetor.php">Avaliações de Setores</a></li>
            <li class="breadcrumb-item active" aria-current="page">Resultados das Avaliações de <?php echo $setor->getNome(); ?></li>
        </ol>
    </nav>
