<?php
    ...
    COUNT(avg_id) as tot
    FROM tbl_avaliacao_gestao ".$condicao." ORDER BY avg_data_criacao DESC LIMIT 4";
    ...
    FROM tbl_avaliacao_gestao ".$condicao." ORDER BY avg_data_criacao DESC LIMIT 30";
...
<div class="container-fluid">
    ...
    <div class="row" style="text-align: center;">
        <div class="col-sm">
            <h3 class="high-text">Avaliações da gestão de <?php echo $_SESSION['empresa']['nome']; ?></h3>
        </div>
    </div>
    <div class="row" style="text-align: center;">
        <div class="col-sm">
